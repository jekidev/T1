...
export default function WorkspacePage() {
  ...
  const loadRepos = async (scope = repoScope) => {
    setRepoBusy(true);
    setMessage("");
    try {
  ...
  const groupedLinks = useMemo(() => Object.groupBy(workspace.hyperlinks, link => link.category), [workspace.hyperlinks]);

  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,hsl(var(--primary)/0.12),transparent_38%),linear-gradient(135deg,hsl(var(--background)),hsl(var(--muted)/0.2))] p-4 md:p-8 select-text">
